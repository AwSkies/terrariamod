...
{
    public class KiwaRodBobber : ModProjectile
    {
        ...
        public override bool PreDrawExtras(SpriteBatch spriteBatch)
        {
            ...
            if (projectile.bobber && Main.player[projectile.owner].inventory[Main.player[projectile.owner].selectedItem].holdStyle > 0)
            {
                ...
                if (type == mod.ItemType<Items.KiwaRod>())
                {
                ...
                while (flag2)
                {
                    ...
                    else
                    {
                        ...
                        Microsoft.Xna.Framework.Color color2 = Lighting.GetColor((int)value.X / 16, (int)(value.Y / 16f), new Microsoft.Xna.Framework.Color(127, 127, 127, 100));
